...
package "trainingmicroservice" {
  [trainingmicroservice RI] -right- [trainingmicroservice RDB]
  [trainingmicroservice RI] -up- [trainingmicroservice API]
  [trainingmicroservice RDB] -down- [trainingmicroservice SPI]
  [trainingmicroservice RI] -down- [trainingmicroservice SPI]
}

@enduml
....

* *trainingmicroservice API*: Contains all the {ms_name} service interface methods
* *trainingmicroservice RI*: Service implementation methods of {ms_name} API
* *trainingmicroservice RDB*: Contains all the DAOs that interact with database
