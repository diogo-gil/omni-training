...
import com.celfocus.omnichannel.telco.apps.trainingappjwe.exception.TrainingAppJWEException;
...
public class AppContext extends AbstractJourneyContext {
	...
	public TrainingAppJWEException exception(String message) {
		return TrainingAppJWEException.of(this, message);
	}

	public TrainingAppJWEException exception(Throwable cause) {
		return TrainingAppJWEException.of(this, cause);
	}
}
