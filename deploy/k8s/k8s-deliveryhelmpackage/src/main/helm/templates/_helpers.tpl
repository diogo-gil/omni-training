...
Create a chart name
*/}}
{{- define "delivery.chartname" -}}
{{- $chartVersion := .Chart.Version | replace "+" "_" -}}
{{- printf "%s-%s" .Chart.Name $chartVersion | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
Create a config map name init
*/}}
{{- define "delivery.name.init" -}}
{{- $name := default .Chart.Name .Values.nameOverride -}}
{{- printf "%s-init" $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
Expand the name of the cert-manager chart.
*/}}
